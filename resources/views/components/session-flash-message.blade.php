@if (session()->hasAny(['success', 'error']))
    <div x-data="{ show: false }" x-init="() => {
        ...
        class="fixed top-2 left-1/2 -translate-x-1/2 z-50 {{ session()->has('success') ? 'bg-brand-primary-900' : 'bg-red-900' }} text-white px-6 py-4 rounded-lg shadow-xl flex items-center gap-4 max-w-md">
