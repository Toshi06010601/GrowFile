<footer class="sm:min-h-56 flex flex-col justify-center bg-gray-50 border-b border-gray-100 px-10 sm:px-40">
    <div class="flex flex-row justify-around gap-10 items-start pt-5 sm:pt-8 pb-8">
        <figure class="flex-1 flex flex-col max-w-96 gap-2">
            <!-- Logo -->
            ...
            <figcaption class="text-center sm:text-left text-base  font-light text-gray-600">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-around justify-start gap-3 sm:gap-10">
                @if (Route::is('home'))
                    <nav class="flex flex-col gap-1 max-w-72 items-start">
                        <h3 class="text-base  sm:text-2xl font-extrabold">Page map</h3>

                        <div class="ml-1 text-base  font-light text-gray-600 flex flex-col items-start">
                ...
                @endif
                <nav class="flex flex-col gap-1 max-w-72 items-start">
                    <h3 class="text-base sm:text-2xl font-extrabold">Site map</h3>
