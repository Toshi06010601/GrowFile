...
<x-modal name="edit-article" :show="false" focusable>
    ...
    <form wire:submit="save" class="px-6 pt-14 pb-6">
        ...
        {{-- Article URL --}}
        <x-modal.input-text label="Article URL" id="article_url" name="form.article_url" placeholder="Article URL" :disabled="!$isOwner" />
        ...
        {{-- Platform Name --}}
        <x-modal.input-text label="Platform Name" id="platform_name" name="form.platform_name" placeholder="Platform Name"
            :disabled="!$isOwner" />

        {{-- Published Date --}}
        <x-modal.input-date label="Published Date" id="published_date" name="form.published_date" placeholder="Describe your article..."
            :disabled="!$isOwner" />
