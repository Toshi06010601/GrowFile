<div>
    <div x-data="{
        ...
        <div class="grid grid-cols-8 gap-1" :class="open ? 'grid-rows-3' : 'grid-rows-1'">
            ...
            <input class="row-span-1 col-span-7 mt-1 block w-auto  rounded-md" x-model="search" placeholder="Search..."
            ...
            <div x-show="open" 
                ...
                class="row-span-2 col-span-7 flex flex-col gap-1 pl-2 border-2 border-x-gray-300 border-b-gray-300 max-h-20 w-full overflow-y-auto">
            ...
            <x-secondary-button x-on:click="addNewTag"
                class="row-span-1 col-span-1 col-start-8 row-start-1 mt-1 text-center"
