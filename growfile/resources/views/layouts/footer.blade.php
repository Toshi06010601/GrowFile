<footer class="sm:min-h-56 flex flex-col justify-center bg-white border-b border-gray-100 pl-10 pr-0 sm:px-40">
    <div class="flex flex-row justify-around gap-10 items-start pt-5 sm:pt-8 pb-8">
        ...
        @if (Route::is('home'))
            <div class="flex flex-col justify-start gap-3 sm:flex-row sm:justify-around ">
        ...
        @endif
        <div class="flex flex-col gap-3 sm:flex-row sm:justify-around ">
            <nav class="flex flex-col gap-1 max-w-72 items-start">
