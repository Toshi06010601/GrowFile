<footer class="bg-white border-b border-gray-100 pl-10 pr-0 sm:px-40">
    <div class="flex flex-row justify-around gap-10 items-start sm:items-center pt-5 pb-8">
        <figure class="flex-1 flex flex-col max-w-96">
            ...
            <figcaption class="text-center sm:text-left text-sm font-light text-gray-600">
                Let us help you showcase your learning ability to recruiters and expand your network with other
                like-minded engineers
            </figcaption>
        </figure>
        <div class="flex-1 flex flex-col gap-3 sm:flex-row sm:justify-around ">
            @if (Route::is('home'))
            <nav class="flex flex-col gap-1 max-w-72 items-start">
                <h3 class="text-lg font-extrabold">Page map</h3>

                <div class="ml-1 text-sm font-light text-gray-600 flex flex-col gap-1 items-start">
            ...
            <nav class="flex flex-col gap-1 max-w-72 items-start">
                <h3 class="text-lg font-extrabold">Site map</h3>
